        ...
        <div class="col-lg-12 panel panel-default" style="padding: 15px;">
            ...
            <div class="form-group" style="width:200px;margin: 0 auto;">
             <?php if($check_watermark['User']['watermark']==''){ ?>
                <a class="btn btn-md btn-danger open-watermark-model" style="width:200px;" 
                        href="#" onclick="$('#watermark-model').modal('show');"
                        >Add Your Watermark</a>
              <?php }else{ ?> 
            ...
            <div class="form-group">
                ...
                <?php echo $this->Form->input('trending_video_title', array('class' => 'form-control', 'div' => false, 'required', 'label' => false, 'placeholder' => 'Video Title...')); ?>
            </div>

            <div class="form-group">
                <lable id="view-lable">Youtube Video Link</lable>
                <?php echo $this->Form->input('trending_video_link', array('class' => 'form-control', 'div' => false, 'label' => false, 'placeholder' => 'Youtube Video URL...')); ?>
            </div>
            ...
            <button type="submit" class="btn-lg btn-primary btn-web-color" id="login-btn" style="width:100%;" >Share Now</button>
